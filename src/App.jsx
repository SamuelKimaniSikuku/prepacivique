...
function LandingModules({ onStartQuiz, onStartMockExam, isPremium, checkPremium }) {
  const modules = [
    {
...
function LandingAdvantages({ onStartQuiz }) {
  const adv = [
    { icon:"🎯", title:"Conditions réelles", desc:"Testez vos connaissances dans des conditions identiques à l'examen civique." },
    { icon:"✅", title:"Conformité légale", desc:"Plateforme 100% conforme au décret 2025-1345" },
    { icon:"📍", title:"Centres d'examen", desc:"Carte interactive des 158 centres agréés en France" },
...
function LandingHowItWorks() {
  const steps = [
    { n:"1", icon:"📱", title:"Sur tablette", desc:"Examen informatisé dans un centre OFII agréé" },
    { n:"2", icon:"🎯", title:"40 questions à choix multiples", desc:"Réparties en 5 thèmes officiels" },
    { n:"3", icon:"⏱️", title:"45 minutes", desc:"Durée maximale pour compléter le test" },
    { n:"4", icon:"✅", title:"32/40 pour réussir", desc:"Score minimum de 80% requis" },
  ];
  return (
...
function LandingWhoMustTake() {
  ...
  const exemptions = [
    ...
    "Résidents légaux en France depuis plus de 10 ans",
  ];
  return (
    <div style={{marginBottom:16}}>
      <div style={{textAlign:"center",marginBottom:14}}>
...
function LandingOfficialFAQ() {
  const faqs = [
    {
      q:"Quel est le score minimum requis pour réussir l'examen civique ?",
      a:"Le score minimum requis est de 32 bonnes réponses sur 40, soit 80%. L'examen comprend 40 questions à choix multiples, et vous disposez de 45 minutes pour les répondre.",
    },
    {
      q:"Combien y a-t-il de questions dans l'examen civique ?",
      a:"L'examen civique comprend 40 questions réparties en 5 thèmes : Principes et valeurs (11), Institutions (6), Droits et devoirs (11), Histoire et géographie (8), Vie en société (4).",
    },
    {
      q:"L'examen civique est-il obligatoire ?",
      a:"Oui, l'examen civique est obligatoire pour tout étranger ayant signé le Contrat d'Intégration Républicaine (CIR) et souhaitant obtenir un titre de séjour pluriannuel en France.",
    },
    {
      q:"Où passer l'examen civique ?",
      a:"L'examen civique se déroule dans un centre de test agréé par l'OFII. Vous recevrez une convocation par courrier indiquant le lieu, la date et l'heure. L'examen se déroule sur tablette ou ordinateur.",
    },
  ];
  return (
    <div style={{marginBottom:16}}>
...
<div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8}}>
            ...
            {/* ── NEW: Exam Simulator CTA ── */}
            <LandingExamSimulator
              onStartTraining={()=>startQuiz(null)}
